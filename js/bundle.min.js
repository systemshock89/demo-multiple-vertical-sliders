...
document.addEventListener('DOMContentLoaded', () => {
  if (document.body.clientWidth >= 992) {
    document.querySelectorAll('.slider').forEach((n, i) => {
      window[`slider${i + 1}`] = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](n, {
...
function bindSwipers() {
  ...
  for (const swiper of swiperList) {
    swiper.setTranslate = function (translate, byController, doNotPropagate) {
      if (doNotPropagate) {
        swiper__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setTranslate.apply(this, arguments);
      } else {
        for (const swiper of swiperList) {
    ...
    swiper.setTransition = function (duration, byController, doNotPropagate) {
      if (doNotPropagate) {
        swiper__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setTransition.apply(this, arguments);
      } else {
        for (const swiper of swiperList) {
